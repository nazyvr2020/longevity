...
export default function MobileMenu(navigation: MobileMenuProps) {
  return (
    <Menu as="div" className="relative z-30 inline-block text-left lg:hidden">
      ...
      >
        <Menu.Items className="absolute right-5 mt-2 w-56 origin-top-right  rounded-md bg-neutral-100 shadow-lg ring-1 ring-color-secondary ring-opacity-5 focus:outline-none ">
          <div className="p-1">
